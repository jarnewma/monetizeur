...
Subscription.destroy_all
   ...
   payment_method_4= PaymentMethod.create(category:  "Paypal", card_nickname: "PlatyPayPal",  bank: "Chase",expiry_date: Date.today, user: user_4 )
    ...
    subscription_1 = Subscription.create(name: "Spotify", subscription_type: "Spotify", category: "Media", payment_method: payment_method_1, user: user_1  )
    subscription_2 = Subscription.create(name: "Headspace", subscription_type: "Headspace", category: "Wellbeing", payment_method: payment_method_2, user: user_2  )
    subscription_3 = Subscription.create(name: "Netflix", subscription_type: "Netflix", category: "Streaming", payment_method: payment_method_3, user: user_3 )
    subscription_4 = Subscription.create(name: "Hudl", subscription_type: "Hudl", category: "Leisure", payment_method: payment_method_4, user: user_4 )
    subscription_5 = Subscription.create(name: "LinkedIn", subscription_type: "LinkedIn", category: "Social", payment_method: payment_method_1, user: user_4 )
    subscription_6 = Subscription.create(name: "Amazon Prime", subscription_type: "Amazon Prime", category: "Shopping", payment_method: payment_method_2, user: user_2 )
    subscription_7 = Subscription.create(name: "Hello Fresh", subscription_type: "Hello Fresh", category: "Food", payment_method: payment_method_3, user: user_3 )
    subscription_8 = Subscription.create(name: "iCloud", subscription_type: "iCloud", category: "Technology", payment_method: payment_method_4, user: user_4  )
